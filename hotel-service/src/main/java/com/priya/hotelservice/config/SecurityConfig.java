package com.priya.hotelservice.config;

import com.priya.hotelservice.security.GatewayAuthFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        log.info("SecurityFilterChain successfully initialized for hotel-service");
        return filterChain;
    }
}
